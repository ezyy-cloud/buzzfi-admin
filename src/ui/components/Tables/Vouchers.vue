  ...
  >
    ...
    <Modal :show="showModal" @close="showModal = false">
      ...
      <form @submit.prevent="addVoucherHandler">
        ...
        <div class="mb-4">
          <label class="block text-gray-700 text-sm font-bold mb-2" for="quota"
            >Quota (GB)</label
          >
          <input
            v-model="quota"
    ...
    <Modal :show="showEditModal" @close="showEditModal = false">
      ...
      <form @submit.prevent="updateVoucherHandler">
        ...
        <div class="mb-4">
          <label class="block text-gray-700 text-sm font-bold mb-2" for="edit-validity"
            >Validity (days)</label
          >
          <input
        ...
        <div class="mb-4">
          <label class="block text-gray-700 text-sm font-bold mb-2" for="edit-quota"
            >Quota (GB)</label
          >
          <input
            v-model="editVoucher.quota"
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="edit-quota"
            type="number"
            placeholder="Quota"
    ...
    <div v-if="!loading && !error" class="flex flex-col">
      ...
      >
        ...
        <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5 space-x-4">
          <div
            class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
            @click="editVoucherHandler(voucher)"
          >
            <svg
              class="fill-current duration-300 ease-in-out"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
            @click="deleteVoucherHandler(voucher)"
          >
            <svg
